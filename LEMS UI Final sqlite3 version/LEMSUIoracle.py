...
class LEMS:
    ...
    def addadmin(self):
        con = oracledb.connect(database=r'admin.db')
        cur = con.cursor()
    ...
    def addstudent(self):
        con = oracledb.connect(database=r'student.db')
        cur = con.cursor()
    ...
    def deletecomp(self):
        con = oracledb.connect(database=r'complaint.db')
        cur = con.cursor()
    ...
    def updatesys(self):
        con = oracledb.connect(database=r'system.db')
        cur = con.cursor()
