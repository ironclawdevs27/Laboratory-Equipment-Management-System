...
#         lbl_menu = Label(self.root7, text="LEMS is owned by MoonDancers Pvt. Ltd.", font=(
#             "Century Gothic", 30, "bold"), bg="#457b9d", fg="white")
#         lbl_menu.place(x=0, y=100, relwidth=1, height=50)
#         lbl_footer = Label(self.root7, text="LEMS - Laboratory Equipment Management System\n\nAutomative Simplification of Administration", font=(
...
#         lbl_clock = Label(self.root7, text=("DATE: "+dd+"-"+mm+"-"+yyyy+"\nTIME: "+hh+":"+min+":"+ss+" "+am_pm), font=(
